...
public class send extends javax.swing.JFrame {
 ...
 public send(String l) {
    ...
    /**
 jTextArea1    * This method is called from within the constructor to initialize the form.
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{              
                ...
                PreparedStatement ps=con.prepareStatement("insert into mail(to1,fro,subject,message) values(?,?,?,?)");
                ps.setString(1,to);
                ps.setString(2,user);
